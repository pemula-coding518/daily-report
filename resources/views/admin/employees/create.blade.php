    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-0.5">Daftarkan karyawan baru ke dalam divisi yang sesuai.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm">
                <form method="POST" action="{{ route('admin.employees.store') }}" class="space-y-6">
                    ...
                    <div class="pt-2">
                        ...
                        <p class="mt-1 ml-6 text-xs text-slate-400">Jika dinonaktifkan, nama karyawan tidak akan muncul di dropdown form publik.</p>
                    </div>
